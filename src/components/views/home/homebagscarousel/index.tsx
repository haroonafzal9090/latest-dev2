  ...
  return (
    <div className="carousel">
      <div className="flex-between">
        <h2 className="md:text-2xl text-[18px]">{title}</h2>
        <Link
          href={`${link}`}
            ...
            <Link href={`/product/${item.id}`}>
              <div className="bg-[#f4f4f4] shadow-lg">
                <div className="relative overflow-hidden group">
                  <div className="relative  group-hover:rotate-2 group-hover:scale-110 group-hover:transition group-hover:ease-in-out group-hover:duration-500 bg-[#f4f4f4]">
                    <Image
